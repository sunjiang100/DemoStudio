...
GY19056_EXT    enum
{
	...
	eGY_rCMD_SELECT_SIM_CARD				= 0x20,	// 	
	eGY_rCMD_GET_REAL_TIME					= 0x21,	// 采集实时时钟
	eGY_rCMD_ERASE_FLASH					   = 0x22,  // 清除指定的Flash地址
	eGY_rCMD_ERASE_FLASH_RECORD_DATA		= 0x23,	// 
	eGY_rCMD_CLEAR_FLASH_PAGE_CNT			= 0x24,	// 清除Flash页计数器（即清除记录的数据）
	eGY_rCMD_GET_FLASH_PAGE_CNT			= 0x25,	// 读取
	// 测试存储器命令字 ///////////////////////////////////////////////////////
	eGY_rCMD_GET_SET_EE_DATA				= 0x28,	// 读写指定铁电地址和长度的数据
	eGY_rCMD_GET_SET_DF_DATA				= 0x29,	// 读写Flash数据
	...
	eGY_rCMD_GET_DRIVER_IC_CARD_INFO		= 0x4c,	// 读取驾驶员IC卡信息128B

	//////////// 一些临时标志    ///////////////////////////////////////////////////////
	eGY_rCMD_SET_8_FLAGS						= 0xae,	// 设置8个标志位
	////////////  下载附加命令（非国标） ////////////////////////////////////////////////
	eGY_rCMD_DRIVING_PARA					= 0x80,	// 疲劳驾驶相关参数
	eGY_rCMD_OVER_SPEED_PARA				= 0x81,	// 设置时间相关值，速度上限、加减速度上限
	eGY_rCMD_LOW_POWER_ALARM_VALUE		= 0x82,	// 设置低压报警值
	
	
	
	///////////////////////////////////////////////////////////////////////////////////
	eGY_rCMD_SET_USER_VEHICLE_NUM			= 0xa2,	// 设置用户车辆编号，4字节10进制字符	
	...
	eGY_rCMD_SET_INIT_SYS					= 0xad,	// 初始化终端存储器。慎用！！
	...
	eGY_rCMD_SET_REG_CODE					= 0xc3,	// 设置注册码
	eGY_rCMD_SET_TER_PHONE_NUM				= 0xc4, 	//设置终端手机号
	eGY_rCMD_SET_BLIND_TEST					= 0xc5,	// 
	eGY_rCMD_SET_CREAT_USER_TEST			= 0xc6,	// 创建开户，主要是测试用串口来设置，不用在菜单按得这么麻烦

	eGY_rCMD_SET_DEFAULT_PARA				= 0xd0,	// 
	eGY_rCMD_GET_FLASH_START_PAGE			= 0xd1, 
	eGY_rCMD_SET_DRIVER_IC_CARD_INFO		= 0xd2,	// 设置驾驶员IC卡信息128B  
	
	////////////	错误代码	//////////////////////////////////////////////////////////
	eGY_rCMD_UP_LOAD_ERROR					= 0xfa,	// 上传出错标志字
	eGY_rCMD_DOWN_LOAD_ERROR				= 0xfb,	// 下传出错标志字

	eGY_rCMD_SEND_SMS                   = 0xfc,  //发送PDU/TEST短信
	
	eGY_rCMD_SET_FACTORY_RESET          = 0xE0,  //恢复出厂设置   
