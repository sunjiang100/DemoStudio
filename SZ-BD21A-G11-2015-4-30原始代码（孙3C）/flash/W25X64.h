...
#define			DF_CSEnable			{ IODIR0 |= (1UL<<21); IOSET0 |= (1UL<<21); IODIR1 |= (1UL<<16); IOCLR1 |= (1UL<<16);NOP();	NOP();}
#define			DF_CSDisable		{ IODIR0 |= (1UL<<21); IOSET0 |= (1UL<<21); IODIR1 |= (1UL<<16); IOSET1 |= (1UL<<16);NOP();	NOP();}
...
public:
	...
	uchar		PageProgram(unsigned long PageAddr,uchar *pData);
	void		PowerDown(void);
	void		ReleasePowerDown(void);
};

DF_EXT	__noinit__		DFCls		DF;
