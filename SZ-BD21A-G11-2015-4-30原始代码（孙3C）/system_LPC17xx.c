...
#define PCLKSEL0_Val          0x00000140
#define PCLKSEL1_Val          0x00050000
#define PCONP_Val             0x87EBB79E
...
/* $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
//   	<o>OSC_SEL: 晶振选择   <0=> 内部4MHz  <1=> 外部11.0592MHz   	<2=> 外部12MHz 
//   	<i> Default: 内部4MHz	
*/
#define		OSC_SEL						2
...
/* $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
//   	<o>CCLK_DIV: CPU频率从PLL的分频系数 <2-255>
//   	<i> Default: 4
*/
...
#define		FpllOut		 (2UL*Fosc*MAIN_PLL_MSEL/MAIN_PLL_NSEL)

#define		Fcclk			 (FpllOut/CCLK_DIV)

#else

#define		FpllOut		 Fosc

#define		Fcclk			 FpllOut
...
//S:\Guoyee\GY-GD11R\GD11R\Config\UserConfig.h
// S:\Guoyee\GY-GD11R\GD11R\system_LPC17xx.c
...
void 		targetInit (void)
{
    ...
    */                                                                    /*  clock source                */
    LPC_SC->PLL0CFG   = (((MAIN_PLL_NSEL - 1) << 16) | (MAIN_PLL_MSEL - 1));    
    ...
    while ((LPC_SC->PLL0STAT & (1ul << 24)) == 0) {  }		// Enable Bit
    
    LPC_SC->CCLKCFG = (FpllOut / Fcclk) - 1;   
    
    while (((LPC_SC->PLL0STAT & (1ul << 26)) == 0)) { }                          /*  Check lock bit status       */
    
    while (((LPC_SC->PLL0STAT & 0x00007FFF) != (MAIN_PLL_MSEL - 1)) && 
           (((LPC_SC->PLL0STAT & 0x00FF0000) >> 16) != (MAIN_PLL_NSEL - 1))) {
    }
    
    LPC_SC->PLL0CON  = 0x03;                                                       /*  connect the PLL             */
    LPC_SC->PLL0FEED = 0xAA;
    LPC_SC->PLL0FEED = 0x55;                                
    while ((LPC_SC->PLL0STAT & (1ul << 25)) == 0) { }                   /*  Wait until the PLL is       */ 
