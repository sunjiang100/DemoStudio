...
Vectors         LDR     PC, Reset_Addr         
                LDR     PC, =0x4004			;Undef_Addr
                LDR     PC, =0x4008			;SWI_Addr
                LDR     PC, =0x400c			;PAbt_Addr
                LDR     PC, =0x4010			;DAbt_Addr
                DCD		0xb8a06f38			; Reserved Vector 
                LDR     PC, =0x4018			;IRQ_Addr
                LDR     PC, =0x401c			;FIQ_Addr

;Reset_Addr      DCD     RootReset_Handler
...
Vectors1        LDR     PC, Reset_Addr         
                LDR     PC, Undef_Addr4000;Undef_Addr
                LDR     PC, SWI_Addr4000;SWI_Addr
                LDR     PC, PAbt_Addr4000;PAbt_Addr
                LDR     PC, DAbt_Addr4000;DAbt_Addr
                DCD		0xb8a06f38			; Reserved Vector                            ; Reserved Vector 
                LDR     PC, IRQ_Addr4000;IRQ_Addr           ;LDR     PC, [PC, #-0x0120]     ; Vector from VicVectAddr
                LDR     PC, FIQ_Addr4000;FIQ_Addr

Reset_Addr4000      DCD     0x4000
Undef_Addr4000      DCD     0x4004
SWI_Addr4000        DCD     0x4008
PAbt_Addr4000       DCD     0x400c
DAbt_Addr4000       DCD     0x4010
                    DCD		 0xb8a06f38			; Reserved Vector                       ; Reserved Address 
IRQ_Addr4000        DCD     0x4018
FIQ_Addr4000        DCD     0x401c

Reset_Addr      DCD     Reset_Handler_11
...
; Reset Handler
                EXPORT  JumpToApplication
JumpToApplication   
				B		0x4000
				B	.

                EXPORT  Reset_Handler_11
Reset_Handler_11   
