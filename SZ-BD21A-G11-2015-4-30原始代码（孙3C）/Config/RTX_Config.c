...
#define OS_TINIT()      PCONP |= (1<<PCON_VAL);         /*  Initialization  */ \
                        ...
                        TIMx(MCR) = 3;                                         \
                        TIMx(TCR) = 1; 										  \
                        VICVectAddr4 = OS_TID_;	\
								VICVectCntl4 = OS_TID_;
								//VICVectAddr4 = (U32)os_clock_interrupt;
                        //VICVectAddr0 = 0;						\
								//VICVectCntl0  = 0x20 | OS_TID_;
                        
                        
								
/////////////////////////////////////////////////////////////////////////////////////
//                        VICVectAddrX = (U32)os_clock_interrupt;\
              //          VICVectAddr31 = 31;// (U32)os_clock_interrupt;\
						//VICVectCntl31  = 0x20 | OS_TID_;
//
...
extern void os_clock_interrupt (void) __irq;//HotPower
//extern __irq void os_clock_interrupt (void);//HotPower
